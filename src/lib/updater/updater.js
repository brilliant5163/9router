...
const packageName = process.env.UPDATER_PKG_NAME || "9routerx";
...
function getDataDir() {
  ...
  if (process.platform === "win32") {
    return path.join(process.env.APPDATA || path.join(os.homedir(), "AppData", "Roaming"), "9routerx");
  }
  return path.join(os.homedir(), ".9routerx");
}

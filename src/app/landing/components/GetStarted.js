        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install {APP_CONFIG.displayName}, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Install {APP_CONFIG.displayName}</h4>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy(`npx ${UPDATER_CONFIG.npmPackageName}`)}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx {UPDATER_CONFIG.npmPackageName}</span>
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#f97815]">&gt;</span> Starting {APP_CONFIG.displayName}...<br/>
